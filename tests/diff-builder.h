...
struct cluster_configurer_t {
    ...
    cluster_configurer_t&& add(std::string_view sha256, std::string_view folder_id, uint64_t index, int64_t max_sequence) noexcept;
...
struct diff_builder_t {
    ...
    diff_builder_t& update_peer(std::string_view sha256, std::string_view name = "",  std::string_view cert_name = "", bool auto_accept = true) noexcept;
