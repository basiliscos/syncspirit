...
struct SYNCSPIRIT_TEST_API diff_builder_t {
    ...
    diff_builder_t &upsert_folder(std::string_view id, std::string_view path, std::string_view label = "") noexcept;
    diff_builder_t &upsert_folder(const db::Folder &data) noexcept;
    ...
    diff_builder_t &finish_file(const model::file_info_t &file, const model::device_t &peer) noexcept;
    diff_builder_t &finish_file_ack(const model::file_info_t &file, const model::device_t &peer) noexcept;
