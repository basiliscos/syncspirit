...
void encode(const Announce&, utils::bytes_view_t);
void encode(const BlockInfo&, utils::bytes_view_t);
void encode(const Close&, utils::bytes_view_t);
void encode(const ClusterConfig&, utils::bytes_view_t);
void encode(const Device&, utils::bytes_view_t);
void encode(const DownloadProgress&, utils::bytes_view_t);
void encode(const FileDownloadProgressUpdate&, utils::bytes_view_t);
void encode(const FileInfo&, utils::bytes_view_t);
void encode(const Folder&, utils::bytes_view_t);
void encode(const Header&, utils::bytes_view_t);
void encode(const IndexBase&, utils::bytes_view_t);
void encode(const Ping&, utils::bytes_view_t);
void encode(const Request&, utils::bytes_view_t);
void encode(const Response&, utils::bytes_view_t);

utils::bytes_t encode(const Hello&, std::size_t prefix);

int decode(utils::bytes_view_t, Announce&);
int decode(utils::bytes_view_t, BlockInfo&);
int decode(utils::bytes_view_t, Close&);
int decode(utils::bytes_view_t, ClusterConfig&);
int decode(utils::bytes_view_t, Device&);
int decode(utils::bytes_view_t, DownloadProgress&);
int decode(utils::bytes_view_t, FileDownloadProgressUpdate&);
int decode(utils::bytes_view_t, FileInfo&);
int decode(utils::bytes_view_t, Folder&);
int decode(utils::bytes_view_t, Header&);
int decode(utils::bytes_view_t, Hello&);
int decode(utils::bytes_view_t, IndexBase&);
int decode(utils::bytes_view_t, Ping&);
