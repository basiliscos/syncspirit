...
struct SYNCSPIRIT_API share_folder_t final : cluster_diff_t {
    ...
    static outcome::result<cluster_diff_ptr_t> create(cluster_t &,  sequencer_t &sequencer,
    ...
    std::string peer_id;
private:
    share_folder_t(const uuid_t &uuid, std::string_view device_id, std::string_view folder_id,
