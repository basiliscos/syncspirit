...
struct SYNCSPIRIT_API update_folder_t final : cluster_diff_t {
    ...
    static outcome::result<cluster_diff_ptr_t> create(const cluster_t &cluster, sequencer_t &sequencer, const model::device_t &source,
    ...
    update_folder_t(std::string_view folder_id, std::string_view peer_id, files_t files, uuids_t uuids, blocks_t new_blocks) noexcept;
