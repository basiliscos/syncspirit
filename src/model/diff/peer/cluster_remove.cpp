...
cluster_remove_t::cluster_remove_t(std::string_view source_device_, keys_t updated_folders_,
                                   keys_t removed_folder_infos_, keys_t removed_files_, keys_t removed_blocks_,
                                   keys_t removed_unknown_folders_) noexcept
    : source_device{source_device_}, updated_folders{std::move(updated_folders_)},
      removed_folder_infos{std::move(removed_folder_infos_)}, removed_files{std::move(removed_files_)},
      removed_blocks{std::move(removed_blocks_)}, removed_unknown_folders{std::move(removed_unknown_folders_)} {}
