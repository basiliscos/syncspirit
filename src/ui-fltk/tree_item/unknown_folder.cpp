...
unknown_folder_t::unknown_folder_t(model::unknown_folder_ptr_t folder_, app_supervisor_t &supervisor, Fl_Tree *tree)
    : parent_t(supervisor, tree), folder{std::move(folder_)} {
