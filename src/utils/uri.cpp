...
uri_ptr_t parse(std::string_view str) noexcept {
...
SYNCSPIRIT_API bool is_parsable(std::string_view string) noexcept { return boost::urls::parse_uri(string).has_value(); }
